...
function Nav() {
    ...
    return (
        <div className="h-20 flex justify-between px-5 align-middle">
            <label className="text-xs flex items-center font-bold">Kanban React</label>
            <label className="text-xs flex items-center">{date.toLocaleDateString()} - {date.toLocaleTimeString()}</label>
